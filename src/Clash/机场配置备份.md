...
function main(config, profileName) {
  ...
  config.rules = [
    ...
    `DOMAIN-KEYWORD,uniss.me,${proxyGroup}`,
    // 雷霆-发布页：https://yuansu.gitbook.io/leiting
    `DOMAIN-KEYWORD,yuansu.gitbook.io,${proxyGroup}`,
    // 雷霆-订阅
    `DOMAIN-KEYWORD,nn8qozmu,${proxyGroup}`,

    // 魔界-官网
    `DOMAIN-KEYWORD,mojie,${proxyGroup}`,
    // 魔界-订阅
    `DOMAIN-KEYWORD,onlysub.mjurl.com,${proxyGroup}`,

    // 一元机场-官网
    `DOMAIN-KEYWORD,一元,${proxyGroup}`,
    // 一元机场-订阅
    `DOMAIN-KEYWORD,sub1.smallstrawberry.com,${proxyGroup}`,

    // Clash Verge官网：https://www.clashverge.dev/
    `DOMAIN-KEYWORD,clashverge,${proxyGroup}`,
    // Clash内核官网：https://wiki.metacubex.one/
    `DOMAIN-KEYWORD,wiki.metacubex.one,${proxyGroup}`,
    // Clash相关网站
    `DOMAIN-KEYWORD,clashios.com,${proxyGroup}`,
    `DOMAIN-KEYWORD,clashjichang.com,${proxyGroup}`,
    `DOMAIN-KEYWORD,clashcn,${proxyGroup}`,
    `DOMAIN-KEYWORD,aijichang.net,${proxyGroup}`,
    ...
    // ChatGPT文件上传
    `DOMAIN-KEYWORD,files.oaiusercontent.com,${proxyGroup}`,
    // Sora
    `DOMAIN-KEYWORD,sora.chatgpt.com,${proxyGroup}`,

    // Cursor
    `DOMAIN-KEYWORD,cursor,${proxyGroup}`,

    // VueUse
    `DOMAIN-KEYWORD,vueuse.org,${proxyGroup}`,

    // Postman
    `DOMAIN-KEYWORD,postman,${proxyGroup}`,
    `DOMAIN-KEYWORD,zerocloud.works,${proxyGroup}`,
    ...
    `DOMAIN-KEYWORD,auth.grazie.ai,${proxyGroup}`,
    `DOMAIN-KEYWORD,anthropic,${proxyGroup}`,

    // IDEA插件
    `DOMAIN-KEYWORD,plugins.jetbrains.com,${proxyGroup}`,
    `DOMAIN-KEYWORD,jetbrains,${proxyGroup}`,
    ...
    // ElementPlus 实验室
    `DOMAIN-KEYWORD,element-plus.run,${proxyGroup}`,
    `DOMAIN-KEYWORD,cdn.jsdelivr.net,${proxyGroup}`,

    // PHP
    `DOMAIN-KEYWORD,php,${proxyGroup}`,

    // blog.junxu666.top
    `DOMAIN-KEYWORD,blog.junxu666.top,${proxyGroup}`,

    // 币安
    `DOMAIN-KEYWORD,binance,${proxyGroup}`,
    `DOMAIN-KEYWORD,bin.bnbstatic.com,${proxyGroup}`,
    `DOMAIN-KEYWORD,public.bnbstatic.com,${proxyGroup}`,
    `DOMAIN-KEYWORD,cdn.cookielaw.org,${proxyGroup}`,
    `DOMAIN-KEYWORD,bnbstatic,${proxyGroup}`,

    // YouTu
    `DOMAIN-KEYWORD,youtu,${proxyGroup}`,
...
proxies:
    - { name: '[核心] 香港 01', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27011, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 香港 02', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27013, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 香港 03', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27015, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 香港 04', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27017, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 香港 05', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27019, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 香港 06', type: trojan, server: s.hkg.ltltltltltltlt.top, port: 27111, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 日本 01', type: trojan, server: s.jpn.ltltltltltltlt.top, port: 27031, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 日本 02', type: trojan, server: s.jpn.ltltltltltltlt.top, port: 27033, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 新加坡 01', type: trojan, server: s.sin.ltltltltltltlt.top, port: 27041, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 新加坡 02', type: trojan, server: s.sin.ltltltltltltlt.top, port: 27043, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 新加坡 03', type: trojan, server: s.sin.ltltltltltltlt.top, port: 27044, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 新加坡 04', type: trojan, server: s.sin.ltltltltltltlt.top, port: 27045, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 美国 01', type: trojan, server: s.usa.ltltltltltltlt.top, port: 27051, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 美国 02', type: trojan, server: s.usa.ltltltltltltlt.top, port: 27053, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 美国 03', type: trojan, server: s.usa.ltltltltltltlt.top, port: 27055, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
    - { name: '[核心] 美国 04', type: trojan, server: s.usa.ltltltltltltlt.top, port: 27057, password: 94566b52-e572-454a-9533-9350a18de2c4, udp: true, sni: www.ithome.com, skip-cert-verify: true }
proxy-groups:
    - { name: 雷霆, type: select, proxies: [自动选择, 故障转移, '[核心] 香港 01', '[核心] 香港 02', '[核心] 香港 03', '[核心] 香港 04', '[核心] 香港 05', '[核心] 香港 06', '[核心] 日本 01', '[核心] 日本 02', '[核心] 新加坡 01', '[核心] 新加坡 02', '[核心] 新加坡 03', '[核心] 新加坡 04', '[核心] 美国 01', '[核心] 美国 02', '[核心] 美国 03', '[核心] 美国 04'] }
    - { name: 自动选择, type: url-test, proxies: ['[核心] 香港 01', '[核心] 香港 02', '[核心] 香港 03', '[核心] 香港 04', '[核心] 香港 05', '[核心] 香港 06', '[核心] 日本 01', '[核心] 日本 02', '[核心] 新加坡 01', '[核心] 新加坡 02', '[核心] 新加坡 03', '[核心] 新加坡 04', '[核心] 美国 01', '[核心] 美国 02', '[核心] 美国 03', '[核心] 美国 04'], url: 'http://www.gstatic.com/generate_204', interval: 86400 }
    - { name: 故障转移, type: fallback, proxies: ['[核心] 香港 01', '[核心] 香港 02', '[核心] 香港 03', '[核心] 香港 04', '[核心] 香港 05', '[核心] 香港 06', '[核心] 日本 01', '[核心] 日本 02', '[核心] 新加坡 01', '[核心] 新加坡 02', '[核心] 新加坡 03', '[核心] 新加坡 04', '[核心] 美国 01', '[核心] 美国 02', '[核心] 美国 03', '[核心] 美国 04'], url: 'http://www.gstatic.com/generate_204', interval: 7200 }
rules:
    - 'DOMAIN,w.nn8qozmu.top,DIRECT'
